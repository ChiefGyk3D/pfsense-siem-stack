...
GRAYLOG_SERVER = "192.0.2.10"  # CHANGE THIS to your SIEM server IP
GRAYLOG_PORT = 5140
...
```python
GRAYLOG_SERVER = "192.0.2.10"  # CHANGE THIS
```
...
```
Nov 24 12:32:15 firewall suricata-forwarder: Starting Python forwarder from /var/log/suricata/suricata_ix055721/eve.json to 192.0.2.10:5140
```
