...
- [PF_INFORMATION_PANEL_ISSUE.md](../troubleshooting/PF_INFORMATION_PANEL_ISSUE.md) - Why PF plugin needs root access
- [SETUP_FILTERLOG_MONITORING_CRON.md](../operations/SETUP_FILTERLOG_MONITORING_CRON.md) - pfBlocker log permissions (separate issue)
- [PFSENSE_FILTERLOG_ROTATION_FIX.md](../troubleshooting/PFSENSE_FILTERLOG_ROTATION_FIX.md) - Filterlog rotation bug
