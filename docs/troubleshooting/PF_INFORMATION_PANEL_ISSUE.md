...
- [SETUP_FILTERLOG_MONITORING_CRON.md](../operations/SETUP_FILTERLOG_MONITORING_CRON.md) - pfBlocker log permissions (still works!)
- [TELEGRAF_PFBLOCKER_SETUP.md](../pfsense/TELEGRAF_PFBLOCKER_SETUP.md) - pfBlocker panel setup
...
**See [TELEGRAF_RESTART_PROCEDURE.md](../pfsense/TELEGRAF_RESTART_PROCEDURE.md) for complete details.**
