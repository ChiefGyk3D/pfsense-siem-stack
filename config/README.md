...
### logstash-suricata.confcurl -XPUT "http://192.0.2.10:9200/_index_template/suricata-template" \
...
**Purpose:**curl -s "http://192.0.2.10:9200/_cluster/settings?filter_path=persistent.action.auto_create_index"
...
**Format:**curl -XPUT "http://192.0.2.10:9200/suricata-2025.11.26" \
